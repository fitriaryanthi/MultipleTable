...
import com.example.dosen.Features.ProdiCRUD.CreateProdi.ProdiCreateDialogFragment;
import com.example.dosen.Features.ProdiCRUD.CreateProdi.ProdiCreateListener;
...
public class ProdiListActivity extends AppCompatActivity implements ProdiCreateListener {
    ...
    private void printSummary() {
        ...
        long studentNum = databaseQueryClass.getNumberOfDosen();
