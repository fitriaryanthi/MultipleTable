...
import com.example.dosen.Features.DosenCRUD.ShowDosenList.DosenListActivity;
import com.example.dosen.R;
import com.example.dosen.Database.DatabaseQueryClass;
import com.example.dosen.Features.ProdiCRUD.UpdateProdiList.ProdiUpdateDialogFragment;
import com.example.dosen.Features.ProdiCRUD.UpdateProdiList.ProdiUpdateListener;
...
public class ProdiListRecyclerViewAdapter extends RecyclerView.Adapter<CustomViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, DosenListActivity.class);
